...
<head>
    <!-- Include Font Awesome stylesheet from CDN -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
</head>
  <meta charset="utf-8">
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
  <title>Index - Precious Memories </title>
...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.php" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">Precious Memories</h1>
      </a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="admin/login.php">Login to Admin</a></li>
      ...
      <!-- <div class="search-form">
        <input type="search" id="search-box" placeholders="search here...">
  ...
  <h2><span>Precious Memories, Proudly rooted in the vibrant city of Pokhara</span></h2>
      <p>We specialize in capturing life’s most significant moments with precision and artistry, delivering high-quality images that preserve your unique story and lasting memories.</p>
